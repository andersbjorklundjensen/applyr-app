    ...
    <div className="container md:flex">
      <div className="md:w-1/2">
        ...
        <h3 className="text-2xl font-semibold">
          Don't waste time keeping track of job applications
        </h3>
        ...
        <Link
          className="inline-block rounded-full py-3 px-7 bg-[#f6cd42] hover:bg-[#f4c632] transition-colors duration-200"
          to="/register"
        >
          Get started!
        </Link>
      ...
      <div className="md:w-1/2">
        <img className="mt-2 w-full" alt="Hero" src="/img/hero-image.jpg" />
      </div>
    </div>
  </BaseLayout>
);
